...
v0.6 计划新增可选的交互式 TUI 和 shell，不改变 v0.5 的消息格式、SQLite schema、Redis keyspace、Consumer Group、投递、ACK、lease、dedup 或 DLQ/EQ replay 语义。现有 Python API 和非交互 `taskflow` 子命令应保持兼容。
