...
class RedisDelivery:
    ...
    def __init__(self, broker: RedisBroker, message: TaskMessage, delivery_id: str,
                 token: str, consumer_id: str, attempt: int,
        ...
        self.message, self.delivery_id, self.consumer_id, self.attempt = (
            message, delivery_id, consumer_id, attempt)
...
class RedisConsumer:
    ...
    def __init__(self, broker: RedisBroker, queue: str, consumer_id: str,
