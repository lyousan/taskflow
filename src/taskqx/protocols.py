...
from .consistency import ConsistencyReport, RepairReport
...
class TaskBroker(Protocol):
    ...
    async def submit_from(
        self, message: TaskMessage, **overrides: Any
    ) -> SubmitResult: ...
    def scheduler(
        self, *, queues: Iterable[str] | None = None, interval: timedelta = ...
    ) -> Any: ...
    def consumer(
        self,
        queue: str,
